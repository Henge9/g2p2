	...
	componentWillMount() {
		...
		axios.get('http://agileboardgame.com/rest/?/d_cards').then(function(result) {
			...
			for (var i = 0; i < cards.length; i++) {
				...
				card = <Defects key={i.toString()} updateCol2Value={self.props.updateCol2Value} updateCol3Value={self.props.updateCol3Value} updateCol4Value={self.props.updateCol4Value} updateCard={self3.updateCard} number={cards[i].number} analytics={cards[i].analytics} development={cards[i].development} test={cards[i].test}/>

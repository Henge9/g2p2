	...
	render() {
		return (
			<div className='column-buttons'>
				<button ref='goButton' className='go-button' onClick={(e) => {this.toggleGoButton(); this.toggleSetButton(); this.props.removePoints(e); this.props.addX(e)}}>NEXT DAY</button>
				<button ref='setButton' className='set-button' onClick={(e) => {this.props.pushB(e); this.toggleSetButton(); this.toggleGoButton()}}>THROW</button>
			</div>
		);
	}
}